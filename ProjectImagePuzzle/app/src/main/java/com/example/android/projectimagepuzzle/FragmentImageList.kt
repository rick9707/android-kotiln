...
class FragmentImageList: Fragment(), AnkoLogger
{
    ...
    override fun onStart()
    {
        ...
        this.recyclerView.layoutManager = GridLayoutManager(this.context, SPAN_COUNT)
        this.adapter.setSpanSizeLookup{ _, position -> if (this.imageList[position].isHeader) SPAN_COUNT else 1 }
        this.recyclerView.adapter = this.adapter
        this.recyclerView.addItemDecoration(MarginItemDecoration(8, SPAN_COUNT))
